    ...
    template: `
        <div class="level">
            <div class="copy-container">
                ...
                <Copy v-if="!copied" @click="copyURL('https://glorpulon.pages.dev/#/level/' + level.path); copied = true"></Copy>
            ...
            <Records :records="level.records" :percentToQualify="(level.percentToQualify) ? level.percentToQualify : 100" />
        </div>
    `,
    methods: {
        copyURL,
